...
### *🎉 News (03/20/2022):*
### * The bug of end and start day in the tropic versoin of the app will be fixed. A new feature to customize the number of consecutives for the tropic version will be added in 03/20. Please wait until 03/21/2022 to use.
